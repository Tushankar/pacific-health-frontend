...
const CodeOfEthicsPolicy = ({ onComplete, savedData, progressCurrent = 0, progressTotal = 1, onFormChange, isReadOnly = false, onNext }) => {
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="grid grid-cols-2 gap-4 md:gap-16 mt-12 mb-12">
                             <div>
                                ...
                                />
                                <div className="font-bold">Signature of Client/ Client Representative <RequiredStar /></div>
                            </div>
                             <div>
                                <input
                                    type="date"
