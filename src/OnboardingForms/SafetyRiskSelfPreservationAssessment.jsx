...
const SafetyRiskSelfPreservationAssessment = ({ 
  ...
  const validateForm = () => {
    ...
    if (!formData.signatures.homeRep || formData.signatures.homeRep.trim() === "") {
      newErrors["signatures.homeRep"] = "Home Representative Signature is required";
    }
    ...
    <div className="flex w-full items-start bg-white text-black font-serif">
      ...
      <form onSubmit={handleSubmit} className="flex-1 flex flex-col items-center mt-4 mb-8">
        ...
        <p className="leading-relaxed mb-6 text-center text-[9px] md:text-[12px]">
          ...
          Health Systems includes assessing for safety/ risk factors, and other
          incidents or historical factors which are of special concern or
          require extra resources. The following list of factors is to be
          addressed with the person and/or person(s) who knows him/her best. In
          gathering the information, please explain all findings with examples,
          and give dates of the last occurrence.
        </p>
        ...
        <div className="w-full border border-black text-[10px] md:text-sm">
            ...
            <div className="border-b border-black p-2">
              <div className="flex flex-col md:flex-row gap-2 md:items-center">
                <div className="font-bold mr-2 w-full md:w-auto">1. Seizures</div>
                ...
                <div className="flex-1 flex flex-col md:flex-row gap-2 md:ml-4">
                    ...
                    <div className="flex items-center gap-2 flex-1">
                        <span className="whitespace-nowrap">Date of last seizure:</span>
                        <input
                          type="date"
                          className="w-full border-b border-black outline-none bg-transparent"
                          value={formData.q1.lastSeizureDate}
                          onChange={(e) =>
                            handleNestedChange("q1", "lastSeizureDate", e.target.value)
                          }
                          readOnly={isReadOnly}
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 ml-0 md:ml-4">
                        ...
                        <label className="inline-flex items-center gap-1 cursor-pointer">
                          <input
                            ...
                            onChange={(e) =>
                              handleNestedChange("q2", "rapidEating", e.target.checked)
                            }
                            disabled={isReadOnly}
                          />{" "}
                          Rapid Eating
                        ...
                        <label className="inline-flex items-center gap-1 cursor-pointer">
                          <input
                            ...
                            onChange={(e) =>
                              handleNestedChange("q2", "excessiveWater", e.target.checked)
                            }
                            disabled={isReadOnly}
                          />{" "}
                        ...
                        <label className="inline-flex items-center gap-1 cursor-pointer">
                          <input
                            ...
                            onChange={(e) =>
                              handleNestedChange("q2", "difficultySwallowing", e.target.checked)
                            }
                            disabled={isReadOnly}
                          />{" "}
                    ...
                    <div className="flex items-center gap-4 md:w-1/4">
                       <label className="inline-flex items-center gap-1 cursor-pointer">
                        <input
                          ...
                          onChange={(e) =>
                            handleRiskFactorANEChange(idx, "yes", e.target.checked)
                          }
                          disabled={isReadOnly}
                        />{" "}
                        Yes
                    ...
                    <div className="flex-1 md:w-1/4">
                        <div className="flex items-center gap-2">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                  handleRiskFactorANEChange(idx, "explain", e.target.value)
                                }
                                readOnly={isReadOnly}
                            />
                        </div>
        ...
        <div className="w-full border border-black border-t-0 text-[10px] md:text-sm">
            ...
            <div className="border-b border-black p-2">
                ...
                <div className="mt-2">
                    <div className="font-bold mb-1">Risk factors for skin breakdown:</div>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                         <label className="inline-flex items-center gap-1 cursor-pointer">
                          <input
                            ...
                            onChange={(e) =>
                              handleNestedChange("q8", "incontinence", e.target.checked)
                            }
                            disabled={isReadOnly}
                          />{" "}
                          Incontinence
                        ...
                        <label className="inline-flex items-center gap-1 cursor-pointer">
                          <input
                            ...
                            onChange={(e) =>
                              handleNestedChange("q8", "contractures", e.target.checked)
                            }
                            disabled={isReadOnly}
                          />{" "}
                          Contractures
                    ...
                    <div className="flex flex-wrap gap-4">
                        <label className="inline-flex items-center gap-1 cursor-pointer">
                          <input
                            ...
                            onChange={(e) =>
                              handleNestedChange("q11", "trespassing", e.target.checked)
                            }
                            disabled={isReadOnly}
                          />{" "}
                          Trespassing
                        ...
                        <label className="inline-flex items-center gap-1 cursor-pointer">
                          <input
                            ...
                            onChange={(e) =>
                              handleNestedChange("q11", "misdemeanor", e.target.checked)
                            }
                            disabled={isReadOnly}
                          />{" "}
                          Misdemeanor
                        ...
                        <label className="inline-flex items-center gap-1 cursor-pointer">
                          <input
                            ...
                            onChange={(e) =>
                              handleNestedChange("q11", "disturbance", e.target.checked)
                            }
                            disabled={isReadOnly}
                          />{" "}
                          Disturbance
            ...
            <div className="border-b border-black p-2">
                ...
                {[...Array(2)].map((_, i) => (
                  <div key={i} className="border-b border-gray-300 h-6 mt-1"></div>
                ))}
            ...
            {/* Additional comments */}
            <div className="border-b border-black p-2">
                <div className="font-bold mb-2">Additional comments or concerns</div>
                <textarea
                ...
                <div className="flex flex-col md:flex-row gap-4 align-bottom">
                    <div className="flex-1">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleNestedChange("signatures", "homeRep", e.target.value)
                          }
                          onKeyDown={handleEnter}
                ...
                <div className="flex flex-col md:flex-row gap-4 align-bottom">
                    <div className="flex-1">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleNestedChange("signatures", "guardian", e.target.value)
                          }
                          onKeyDown={handleEnter}
                          readOnly={isReadOnly}
                        />
