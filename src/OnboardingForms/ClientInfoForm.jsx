...
const Form01ClientInfo = ({ onComplete, savedData, progressCurrent = 0, progressTotal = 1, selectedProgram, onFormChange, isReadOnly = false, onNext, ...props }) => {
  ...
  return (
    <div className="flex w-full items-start">
      ...
      <div className="flex-1 flex flex-col items-center">
        <div className="w-full text-black font-serif flex flex-col items-center mb-8">
            {/* Paper Container */}
            <form
            onSubmit={handleSubmit}
            className="w-[98%] md:w-[85%] lg:w-[75%] p-2 md:p-8 bg-white text-[9px] md:text-sm leading-snug shadow-lg"
            >
            {/* HEADER */}
            ...
            >
                <tbody>
                <tr>
                    <td style={td}>Last Name: <RequiredStar /></td>
                    <td style={td} colSpan="3">
                    <input
                        style={getInputStyle("lastName")}
                        className={errors.lastName ? "border-red-500 shadow-outline-red" : ""}
                    ...
                    <td style={td}>First Name: <RequiredStar /></td>
                    <td style={td} colSpan="3">
                    <input
                        style={getInputStyle("firstName")}
                        className={errors.firstName ? "border-red-500 shadow-outline-red" : ""}
                    ...
                    <td style={td}>
                      ...
                      <label style={{ cursor: "pointer", marginLeft: "8px" }}>
                        <input
                          ...
                          onChange={(e) => handleNestedChange("program", "now", e.target.checked)}
                        />
                        NOW
                      </label>
                      <label style={{ cursor: "pointer", marginLeft: "12px" }}>
                        <input
                          ...
                          onChange={(e) => handleNestedChange("program", "comp", e.target.checked)}
                        />
                        COMP
                      </label>
                    </td>
                ...
                <tr>
                    <td style={td}>Street Address: <RequiredStar /></td>
                    <td style={td} colSpan="3">
                    <input
                        style={getInputStyle("streetAddress")}
                        className={errors.streetAddress ? "border-red-500 shadow-outline-red" : ""}
                    ...
                    <td style={td}>
                      ...
                      <label style={{ cursor: "pointer", marginLeft: "8px" }}>
                        <input
                          ...
                          onChange={(e) => handleNestedChange("services", "cls", e.target.checked)}
                        />
                        CLS
                      </label>
                      <label style={{ cursor: "pointer", marginLeft: "12px" }}>
                        <input
                          ...
                          onChange={(e) => handleNestedChange("services", "cai", e.target.checked)}
                        />
                        CAI
                      </label>
                      <label style={{ cursor: "pointer", marginLeft: "12px" }}>
                        <input
                          ...
                          onChange={(e) => handleNestedChange("services", "respite", e.target.checked)}
                        />
                        RESPITE
                      </label>
                    </td>
                ...
                <tr>
                    ...
                    <td style={td}>Phone: <RequiredStar /></td>
                    <td style={td} colSpan="3">
                    <input
                        style={getInputStyle("phone")}
                        className={errors.phone ? "border-red-500 shadow-outline-red" : ""}
                ...
                <tr>
                    <td style={td}>Sex: <RequiredStar /></td>
                    <td style={td} colSpan="3">
                    <input
                        style={getInputStyle("sex")}
                        className={errors.sex ? "border-red-500 shadow-outline-red" : ""}
                        value={formData.sex}
                        onChange={(e) => {
                          handleChange("sex", e.target.value);
                          if (errors.sex) setErrors(prev => ({ ...prev, sex: null }));
                        }}
                    />
                    </td>
                ...
                <tr>
                    <td style={td}>SSN#: <RequiredStar /></td>
                    <td style={td} colSpan="3">
                    <input
                        style={getInputStyle("ssn")}
                        className={errors.ssn ? "border-red-500 shadow-outline-red" : ""}
                        value={formData.ssn}
                        onChange={(e) => {
                ...
                <tr>
                    <td style={td}>Date of Birth: <RequiredStar /></td>
                    <td style={td} colSpan="3">
                    <input
                        style={getInputStyle("dob")}
                        className={errors.dob ? "border-red-500 shadow-outline-red" : ""}
                        value={formData.dob}
                        onChange={(e) => {
                    ...
                    <td style={td}>Medicaid #: <RequiredStar /></td>
                    <td style={td} colSpan="3">
                    <input
                        style={getInputStyle("medicaid")}
                        className={errors.medicaid ? "border-red-500 shadow-outline-red" : ""}
                        value={formData.medicaid}
                        onChange={(e) => {
                          handleChange("medicaid", e.target.value);
                          if (errors.medicaid) setErrors(prev => ({ ...prev, medicaid: null }));
                        }}
                    />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <input
                        ...
                        onChange={(e) =>
                        handleNestedChange("nextOfKin", "name", e.target.value)
                        }
                    />
                    </td>
                ...
                <tr>
                    ...
                    <input
                        ...
                        onChange={(e) =>
                        handleNestedChange("nextOfKin", "address", e.target.value)
                        }
                    />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <input
                        ...
                        onChange={(e) =>
                        handleNestedChange("nextOfKin", "phone", e.target.value)
                        }
                    />
                    </td>
                </tr>
                ...
                {[0, 1, 2].map((i) => (
                    ...
                    <td style={td} colSpan="2">
                        ...
                        onChange={(e) =>
                            handleArrayChange("contacts", i, "name", e.target.value)
                        }
                        />
                    </td>
                    <td style={td} colSpan="2">
                    ...
                    <td style={td} colSpan="2">
                        ...
                        onChange={(e) =>
                            handleArrayChange("contacts", i, "phone", e.target.value)
                        }
                        />
                    </td>
                    <td style={td} colSpan="2">
                ...
                {[0, 1, 2].map((i) => (
                    ...
                    <td style={td} colSpan="2">
                        ...
                        onChange={(e) =>
                            handleArrayChange("physicians", i, "type", e.target.value)
                        }
                        />
                    </td>
                    <td style={td} colSpan="2">
                        ...
                        onChange={(e) =>
                            handleArrayChange("physicians", i, "name", e.target.value)
                        }
                        />
                    </td>
                    <td style={td} colSpan="2">
