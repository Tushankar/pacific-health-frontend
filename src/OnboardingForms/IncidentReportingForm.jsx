...
const IncidentReportingForm = ({ onComplete, savedData, progressCurrent = 0, progressTotal = 1, onFormChange, isReadOnly = false, onNext }) => {
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2 mb-2">
            ...
            <label className="flex items-center gap-1 ml-2">
              <input
                ...
                onChange={handleCheckbox(["incidentTypes", "abuse", "physical"])}
                disabled={isReadOnly}
              />{" "}
              Physical
            </label>
            ...
            <label className="flex items-center gap-1 ml-2">
              <input
                ...
                onChange={handleCheckbox(["incidentTypes", "abuse", "staffToClient"])}
                disabled={isReadOnly}
              />{" "}
              Staff to Client
            </label>
          ...
          <div className="flex flex-wrap items-center gap-2 mb-2">
            ...
            <label className="flex items-center gap-1 ml-2">
              <input
                ...
                onChange={handleCheckbox(["incidentTypes", "death", "unexpected"])}
                disabled={isReadOnly}
              />{" "}
              Unexpected
            </label>
            <label className="flex items-center gap-1 ml-2">
              <input
                ...
                onChange={handleCheckbox(["incidentTypes", "death", "waiverRequestPending"])}
                disabled={isReadOnly}
              />{" "}
            ...
            <label className="flex items-center gap-1 ml-2">
              <input
                ...
                onChange={handleCheckbox(["incidentTypes", "death", "hospiceProvided"])}
                disabled={isReadOnly}
              />{" "}
              Hospice provided
            </label>
            <label className="flex items-center gap-1 ml-2">
              <input
                ...
                onChange={handleCheckbox(["incidentTypes", "death", "called911"])}
                disabled={isReadOnly}
              />{" "}
              911 called (Time{" "}
              <input
          ...
          <div className="flex flex-wrap items-center gap-2 mb-2">
            ...
            <label className="ml-2 flex items-center gap-1">
              <input
                ...
                onChange={handleCheckbox(["incidentTypes", "seriousInjury", "resultedInDeath"])}
                disabled={isReadOnly}
              />{" "}
              resulted in death
            </label>
            <label className="ml-4 flex items-center gap-1">
              <input
                ...
                onChange={handleCheckbox(["incidentTypes", "seriousInjury", "hospitalAdmission"])}
                disabled={isReadOnly}
              />{" "}
              Hospital admission
            </label>
            <label className="ml-4 flex items-center gap-1">
              <input
                ...
                onChange={handleCheckbox(["incidentTypes", "seriousInjury", "erVisit"])}
                disabled={isReadOnly}
              />{" "}
              ER visit
            </label>
            <label className="ml-4 flex items-center gap-1">
              <input
                ...
                onChange={handleCheckbox(["incidentTypes", "seriousInjury", "mdVisit"])}
                disabled={isReadOnly}
              />{" "}
              MD visit
            </label>
          ...
          <div className="flex flex-wrap items-center gap-2 mb-2">
            ...
            <label className="ml-2 flex items-center gap-1">
              <input
                ...
                onChange={handleCheckbox(["incidentTypes", "externalDisaster", "fire"])}
                disabled={isReadOnly}
              />{" "}
              Fire
            </label>
            <label className="ml-4 flex items-center gap-1">
              <input
                ...
                onChange={handleCheckbox(["incidentTypes", "externalDisaster", "flood"])}
                disabled={isReadOnly}
              />{" "}
              Flood
            </label>
            <label className="ml-4 flex items-center gap-1">
              <input
                type="checkbox"
                checked={formData.incidentTypes.externalDisaster.physicalPlantDamage}
                onChange={handleCheckbox(["incidentTypes", "externalDisaster", "physicalPlantDamage"])}
                disabled={isReadOnly}
              />{" "}
            ...
            <label className="ml-4 flex items-center gap-1">
              <input
                type="checkbox"
                checked={formData.incidentTypes.externalDisaster.clientsRelocated}
                onChange={handleCheckbox(["incidentTypes", "externalDisaster", "clientsRelocated"])}
                disabled={isReadOnly}
              />{" "}
              Clients relocated
            </label>
          ...
          <div className="flex flex-wrap items-center gap-2 mb-2">
            ...
            <span className="ml-2">
              ...
              <input
                type="date"
                value={formData.incidentTypes.missingResident.policeNotifiedDate}
                onChange={handleInput(["incidentTypes", "missingResident", "policeNotifiedDate"])}
                onKeyDown={handleEnter}
                readOnly={isReadOnly}
              ...
              <input
                type="text"
                value={formData.incidentTypes.missingResident.policeNotifiedTime}
                onChange={handleInput(["incidentTypes", "missingResident", "policeNotifiedTime"])}
                onKeyDown={handleEnter}
                readOnly={isReadOnly}
                className="border-b border-black w-16 outline-none text-center text-[9px] md:text-sm bg-transparent"
              />
          ...
          <div className="flex flex-wrap items-center gap-2 mb-4">
            ...
            <label className="ml-4 flex items-center gap-1">
              <input
                ...
                onChange={handleCheckbox(["incidentTypes", "other", "exploitation"])}
                disabled={isReadOnly}
              />{" "}
              Exploitation
            </label>
            <label className="ml-4 flex items-center gap-1">
              <input
                ...
                onChange={handleCheckbox(["incidentTypes", "other", "criminalRecord"])}
                disabled={isReadOnly}
              />{" "}
            ...
            <label className="ml-4 flex items-center gap-1">
              <input
                ...
                onChange={handleCheckbox(["incidentTypes", "other", "insuranceWill"])}
                disabled={isReadOnly}
              />{" "}
              Insurance/will
            </label>
          ...
          <div className="space-y-4 mb-6">
            {[
              { label: "Residents Name:", path: ["notifications", "residentName"] },
              { label: "Family/guardian/responsible party:", path: ["notifications", "familyGuardian"] },
              { label: "Physician:", path: ["notifications", "physician"] },
              { label: "Police:", path: ["notifications", "police"] },
              { label: "Other (specify)", path: ["notifications", "otherNotify"] },
              { label: "Alleged Perpetrator Name:", path: ["notifications", "perpetratorName"] },
              { label: "Relationship to Resident:", path: ["notifications", "relationshipToResident"] },
              { label: "Current Address:", path: ["notifications", "currentAddress"] },
              { label: "Phone:", path: ["notifications", "phone"] },
              { label: "City: State: Zip:", path: ["notifications", "cityStateZip"] },
              { label: "Witness Names:", path: ["notifications", "witnessNames"] },
              { label: "Address:", path: ["notifications", "witnessAddress"] },
              { label: "Phone Number:", path: ["notifications", "witnessPhone"] },
              { label: "Relationship to Resident:", path: ["notifications", "witnessRelationship"] },
            ].map((field, idx) => (
