    ...
    <div className="flex flex-col-reverse 2xl:flex-row w-full items-start">
      ...
      <div className="flex-1 flex flex-col items-center">
        ...
        >
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-col items-center mb-4 text-center">
                ...
                <p className="mt-2 text-[9px] text-justify max-w-xl">
                  This agreement is between Pacific Health Systems LLC
                  (hereafter "Provider") located at 213 Corporate Center Dr,
                  Suite 325 Stockbridge Georgia 30281.
                </p>
              </div>
              ...
              <div className="mb-4">
                <div className="flex flex-col md:flex-row mb-1 gap-2 md:gap-0">
                  <span className="font-bold whitespace-nowrap mr-2 mt-1">
              ...
              <div className="mb-4">
                ...
                <ol className="list-decimal ml-6 space-y-1 text-justify">
                  <li>
                    Not discriminate or permit discrimination against any person
                    or group of people on the grounds of age, race, sex, color,
                    religion, national origin, disability, or client's failure
                    to execute advance directives.
                  </li>
                  <li>
                    No discrimination, coerce or otherwise cause reprisal for
                    complaints/grievance filed by the Client/Client
                    Representative.
                  </li>
                  <li>
                  ...
                  <li>
                    Respond to questions from the Client or Client's
                    Representative with 30 minutes after they call 678-228-8031
                    (Client Care Coordinator).
                  </li>
                  <li>
                    Hired qualified Personal Support Aides (PSA) to provide
                    In-Home Services.
                  </li>
                  <li>
                    Not accept clients when Provider does not have the capacity
                    to meet the needs of the Client.
                  </li>
                  <li>
                    Keep client's information confidential and will not release
                    the client's information without the Client/ Client's
              ...
              <div className="mb-4">
                ...
                <p className="mb-1">
                  Please list the type of services you would need the caregiver
                  to provide for you in your own word:
                </p>
                <p className="mb-1">
            ...
            <div className="mt-8 pt-8 border-t border-gray-300">
              <div className="mb-4 text-justify space-y-2">
                ...
                <p>
                  ...
                  months following the termination of this Agreement, whether
                  such termination is voluntary or involuntary, Client will not
                  hire any of Company employees. If Client hires a Company
                  employee, Client agrees to pay Company a recruitment and
                  training fee of three thousand ($3,000.00) dollars per
                  employee.
                </p>
                <p>
                  If Undersigned or Client wishes to interrupt or terminate the
                  Services provided under this agreement for any reason,
                  Undersigned agrees to give Provider at least seven (7) days
                  advance notice, or if seven (7) days advance notice is not
                  possible under the circumstances, to provide notice as soon as
                  possible. However, the Client or Undersigned may cancel
                  services at any time. Provider may terminate the Services for
                  any reason upon twenty-four (24) hour notice to Client.
                </p>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="grid grid-cols-[1fr_50px_50px] gap-2 mb-2 items-center">
                  ...
                  <div className="text-center">
                    <input
                      ...
                      onChange={() =>
                        handleSingleSelect("accessVehicle", "yes")
                      }
                    />
                  </div>
                  <div className="text-center">
                ...
                <div className="flex gap-2">
                  ...
                  <label className="flex items-center gap-1">
                    <input
                      ...
                      onChange={() =>
                        handleSingleSelect("receivedRights", "yes")
                      }
                    />{" "}
                    Yes
                  </label>
                  <label className="flex items-center gap-1">
                    <input
                      ...
                      onChange={() =>
                        handleSingleSelect("receivedRights", "no")
                      }
                    />{" "}
                    No
                  </label>
                ...
                <p className="mt-2">
                  For information, questions, or complaints about services
                  provided by Pacific Health Systems please call the
                  Administrator @ 678-702-2474.
                </p>
                <p>
                  In the event there is a complaint or problem that we have been
                  made aware of that cannot be resolved, you may contact
                  Healthcare Facility Regulation Division, Health Care Section
                  at 404-657-5856 or for information call 404-657-5700.
                </p>
              </div>
                ...
                <div className="space-y-1 ml-4">
                  ...
                  <div className="ml-4 space-y-1">
                    <label className="flex gap-2">
                      <input
                        ...
                        onChange={handleChange}
                      />{" "}
                      Community Living Supports (Medicaid will be billed
                      $6.35/unit of 15-clock minute)
                    </label>
                    <label className="flex gap-2">
                      <input
                        type="checkbox"
                    ...
                    <div className="flex gap-4 ml-6">
                      ...
                      <label className="flex gap-1">
                        <input
                          ...
                          checked={
                            formData.paymentSource.nowComp.medicalSupplies
                          }
                          onChange={handleChange}
                        />{" "}
                  ...
                  <label className="flex gap-2 font-bold mt-2">
                    <input
                      ...
                      onChange={handleChange}
                    />{" "}
                    SOURCE (Medicaid will be billed $9.02/unit of 30-clock
                    minutes)
                  </label>
                  ...
                  <label className="flex gap-2 font-bold mt-2">
                    <input
                      ...
                      onChange={handleChange}
                    />{" "}
                    ICWP (Medicaid will be billed $17.96/unit of 60-clock
                    minutes)
                  </label>
                  ...
                  <label className="flex gap-2 font-bold mt-2">
                    <input
                      ...
                      onChange={handleChange}
                    />{" "}
                    GAPP (Medicaid will be billed $10.63/unit for RN,
                    $37.28/Unit for LPN and $5.00/Unit for CNA. A unit is 15
                    minutes)
                  </label>
                  ...
                  <label className="flex gap-2 font-bold mt-2">
                    <input
                      ...
                      onChange={handleChange}
                    />{" "}
                    Structured Family Caregiving (Medicaid will be billed $90.20
                    per unit)
                  </label>
                </div>
              </div>
              ...
              <div className="mt-8">
                <p className="mb-8 font-bold text-justify">
                  The Service Agreement will become effective and bind the
                  Provider and the Client/ Client representative to the terms in
                  the Service Agreement when they each sign the agreement
                </p>
                ...
                <div className="flex flex-col md:flex-row md:items-end mb-6 gap-4 md:gap-0">
                  ...
                  <div className="flex items-end md:ml-4">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        handleChange(e);
                        if (errors.dateClient)
                          setErrors((prev) => ({ ...prev, dateClient: null }));
                      }}
                ...
                <div className="flex flex-col md:flex-row md:items-end mb-8 gap-4 md:gap-0">
                  <div className="flex items-end flex-1 min-w-0">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        handleChange(e);
                        if (errors.signatureAgency)
                          setErrors((prev) => ({
                            ...prev,
                            signatureAgency: null,
                          }));
                      }}
                  ...
                  <div className="flex items-end md:ml-4">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        handleChange(e);
                        if (errors.dateAgency)
                          setErrors((prev) => ({ ...prev, dateAgency: null }));
                      }}
          ...
          {/* Action Buttons */}
          <div className="w-[98%] md:w-[85%] lg:w-[72%] px-2 md:px-8 pb-8 bg-white rounded-b-lg shadow-lg flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3">
