        ...
        <div className="space-y-16">
            ...
            <section>
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h2 className="text-2xl font-black text-blue-950 tracking-tight">NOW & COMP Waiver Applicants</h2>
                        <p className="text-slate-500 font-medium text-sm">Direct administrative queue for intellectual and developmental disability waivers.</p>
                    </div>
                </div>
